<div class="flex-1 p-6 bg-[#e6e7ec] min-h-screen id=qr-code">
    ...
    <div class="flex flex-col lg:flex-row items-stretch gap-6">
        <div class="bg-[#F1F7F9] rounded-lg py-12 px-6 w-full max-w-2xl flex flex-col items-center justify-between">
            <div class="w-full flex flex-row items-start gap-4 mb-6">
                ...
                <label class="block text-xs font-medium text-gray-500 mb-2">CAMPUS</label>
                    <select id="campus-select" class="w-full border border-[#262627] rounded-md px-2 py-2 text-[#1e1e1e] text-sm focus:outline-none bg-[#e6e7ec]">
                    ...
                    <div class="mb-4">
                    <label class="block text-xs font-medium text-gray-500">DIVISION</label>
                    <select id="division-select" class="w-full border border-[#262627] rounded-md px-2 py-2 text-[#1e1e1e] text-sm focus:outline-none bg-[#e6e7ec]">
                     ...
                     <div class="mb-4">
                    <label class="block text-xs font-medium text-gray-500">OFFICE</label>
                    <select id="office-select" class="w-full border border-[#262627] rounded-md px-2 py-2 text-[#1e1e1e] text-sm focus:outline-none bg-[#e6e7ec]">
              ...
              <button id="generate-btn" class="flex justify-center items-center gap-2 w-1/3 mx-auto mt-4 border border-[#262627] bg-[#e6e7ec] hover:bg-blue-700 text-[#1e1e1e] rounded-md py-2 text-sm font-medium transition">
               <img src="resources/svg/color-wand-outline.svg" alt="Magic-Wand-Icon" width="20" height="20">
                 Generate
              </button>
                </div>
                <div id="qr-section" class="border border-gray-300 p-2 rounded-md w-60 h-60 bg-transparent flex items-center justify-center">
        ...
        <div class="bg-[#F1F7F9] shadow-md rounded-lg p-6 w-full max-w-sm flex flex-col items-center">
            ...
            <div class="flex gap-3 mb-6">
              <div class="flex flex-col justify-center items-center w-10 h-10 border-2 rounded-md bg-blue-100 border-blue-500 cursor-pointer hover:scale-105 transition-transform" onclick="selectTheme('blue')">
                 <img src="resources/svg/scan-qr-code-blue.svg" alt="qr-code-blue-icon" width="16" height="16">
                 <img src="resources/svg/blue-ellipse.svg" alt="blue-ellipse" width="16" height="16">
                 <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
              </div>
              <div class="flex flex-col justify-center items-center w-10 h-10 border-2 rounded-md bg-orange-100 border-orange-500 cursor-pointer hover:scale-105 transition-transform" onclick="selectTheme('orange')">
                <img src="resources/svg/scan-qr-code-orange.svg" alt="orange-qr-code-icon" width="16" height="16">
                <img src="resources/svg/orange-ellipse.svg" alt="orange-ellipse-icon" width="16" height="16">
                <div class="w-2 h-2 bg-orange-500 rounded-full mt-1"></div>
              </div>
               <div class="flex flex-col justify-center items-center w-10 h-10 border-2 rounded-md bg-pink-100 border-pink-500 cursor-pointer hover:scale-105 transition-transform" onclick="selectTheme('pink')">
                 <img src="resources/svg/scan-qr-code-pink.svg" alt="pink-qr-code" width="16" height="16">
                 <img src="resources/svg/pink-ellipse.svg" alt="pink-ellipse-icon" width="16" height="16">
                 <div class="w-2 h-2 bg-pink-500 rounded-full mt-1"></div>
               </div>
               <div class="flex flex-col justify-center items-center w-10 h-10 border-2 rounded-md bg-green-100 border-green-500 cursor-pointer hover:scale-105 transition-transform" onclick="selectTheme('green')">
                <img src="resources/svg/scan-qr-code-green.svg" alt="green-qr-code" width="16" height="16">
                <img src="resources/svg/green-ellipse.svg" alt="green-ellipses-icon" width="16" height="16">
            ...
            <button class="flex justify-center items-center gap-2 w-1/3 border border-[#262627] bg-[#e6e7ec] hover:bg-blue-700 text-[#1e1e1e] rounded-md py-2 text-sm font-medium transition">

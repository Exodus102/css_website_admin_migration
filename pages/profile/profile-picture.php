<div class="w-full lg:w-1/4 bg-[#F1F7F9] p-6 rounded-lg shadow-md">
        ...
        <div class="flex flex-col items-center space-y-4">
            ...
            <div class="text-center">
                <h2 class="text-xl font-bold text-[#1E1E1E]">
                    ...
                    ?></h2>
                <p class="text-gray-500"><?php echo htmlspecialchars($_SESSION['user_type'] ?? 'Guest'); ?></p><br>
                <label for="dp-file-input" class="cursor-pointer gap-1 flex justify-center items-center bg-[#D6D7DC] border border-[#1E1E1E] px-4 py-1 rounded shadow-sm text-sm font-bold">

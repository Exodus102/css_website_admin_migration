...
<!-- Add Division Dialog -->
<dialog id="add-division-dialog" class="p-6 rounded-md shadow-lg backdrop:bg-black backdrop:bg-opacity-50">
    <form id="add-division-form" method="POST">
        <h3 class="font-bold text-lg mb-4">Add Division</h3>
        <div>
            <label for="division-name" class="block text-sm font-medium text-gray-700">DIVISION</label>
            <input type="text" id="division-name" name="division_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="Name of New Division" required>
        </div>
        <div class="mt-6 flex justify-end gap-4">
            <button type="button" id="cancel-add-division" class="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">Cancel</button>
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-amber-700">Save</button>
        </div>
    </form>
</dialog>

<!-- Edit Division Dialog -->
<dialog id="edit-division-dialog" class="p-6 rounded-md shadow-lg backdrop:bg-black backdrop:bg-opacity-50">
    <form id="edit-division-form" method="POST">
        <h3 class="font-bold text-lg mb-4">Edit Division</h3>
        ...
        <div>
            ...
            <input type="text" id="edit-division-name" name="division_name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
        </div>
        <div class="mt-6 flex justify-end gap-4">
            <button type="button" id="cancel-edit-division" class="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300">Cancel</button>

<header class="absolute top-0 right-0 bg-[#F1F7F9] shadow-md p-4 flex items-center w-full">
    ...
    <a href="dcc-layout.php?page=profile" class="group flex place-content-end items-center space-x-2 w-1/6 hover:bg-gray-100 rounded-lg p-1 transition-colors duration-200">
